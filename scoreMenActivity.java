...
public class scoreMenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_men);

        handicap = (EditText) findViewById(R.id.handicapEditText);

        hole1 = (EditText) findViewById(R.id.editText1);
        hole2 = (EditText) findViewById(R.id.editText2);
        hole3 = (EditText) findViewById(R.id.editText3);
        hole4 = (EditText) findViewById(R.id.editText4);
        hole5 = (EditText) findViewById(R.id.editText5);
        hole6 = (EditText) findViewById(R.id.editText6);
        hole7 = (EditText) findViewById(R.id.editText7);
        hole8 = (EditText) findViewById(R.id.editText8);
        hole9 = (EditText) findViewById(R.id.editText9);
        hole10 = (EditText) findViewById(R.id.editText10);
        hole11 = (EditText) findViewById(R.id.editText11);
        hole12 = (EditText) findViewById(R.id.editText12);
        hole13 = (EditText) findViewById(R.id.editText13);
        hole14 = (EditText) findViewById(R.id.editText14);
        hole15 = (EditText) findViewById(R.id.editText15);
        hole16 = (EditText) findViewById(R.id.editText16);
        hole17 = (EditText) findViewById(R.id.editText17);
        hole18 = (EditText) findViewById(R.id.editText18);


        calculate = (Button) findViewById(R.id.calculateButton);
        clear = (Button) findViewById(R.id.clearButton);
        grossScore = (TextView) findViewById(R.id.grossTextView);
        netScore = (TextView) findViewById(R.id.netScoreTextView);
